...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(setq
 dired-dwim-target t            ; if another Dired buffer is visible in another window,
                                ; use that directory as target for Rename/Copy
...
(add-hook 'dired-buffer-mode 'auto-revert-mode)

;; if it is windows, use the following listing switches
...
;; GROUP: No group                   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; since ztree works with fiels and directories,
;; let's consider it in group Files.
(require 'ztree-diff)
(require 'ztree-dir)
;; M-x ztree-diff, then select the left and right directories to compare.
;; M-x ztree-dir to explore the filesystem:
